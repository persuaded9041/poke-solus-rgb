...
InternalMapEntries:
	...
	internal_map MEW_ROOM,                       2, 15, PokemonMansionName ; dereknote - new map
	internal_map FOSSIL_ROOM,                    0,  4, VictoryRoadName ; dereknote - new map
	internal_map TRADER_HOUSE,                   7,  5, CeladonCityName ; dereknote - new map
